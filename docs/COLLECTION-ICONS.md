# آرشیو پرامپت آیکن دسته

این آیکن‌ها دیگر در Grid عمومی عکاسی استفاده نمی‌شوند، چون معماری فعلی همهٔ عکس‌ها را مستقیماً نمایش می‌دهد و دسته‌ها فیلتر متنی هستند. پرامپت زیر برای حفظ زبان بصری و استفادهٔ احتمالی آینده نگه داشته شده است.
...
اگر برای کاربرد دیگری خروجی گرفتی، مطمئن شو فایل واقعاً کانال Alpha دارد؛ نمایش شطرنجی نباید داخل خود PNG ذخیره شده باشد. Schema فعلی عکاسی فیلد `icon` ندارد، پس افزودن فایل کنار `index.md` به‌تنهایی آن را روی سایت نمایش نمی‌دهد.
