...
هر مجموعه فقط یک فایل و یک نام انگلیسی دارد. همهٔ عکس‌های همهٔ مجموعه‌ها در صفحهٔ Photography به‌صورت Grid نمایش داده می‌شوند و هر کارت مستقیماً به صفحهٔ همان عکس می‌رود. Astro از تصاویر Preview اندازه‌های Responsive تولید می‌کند و تصاویر فهرست Lazy-load می‌شوند.
